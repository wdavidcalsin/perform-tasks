    ...
    <div className="h-screen w-full bg-primary flex justify-center items-center z-0 ">
      ...
      >
        ...
        <form action="">
          ...
          <textarea placeholder="Description ..." className="w-full max-w-full h-40 resize border border-secondary rounded-md focus:outline-none  py-2 px-3 mt-2 mb-2 font-noto-sans"></textarea>
